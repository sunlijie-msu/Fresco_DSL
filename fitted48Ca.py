...
# Execute frescox
os.system("frescox < /mnt/hgfs/Fresco_DSL/frescox_inputs/48Ca.in /mnt/hgfs/Fresco_DSL/frescox_inputs/search-el.in /mnt/hgfs/Fresco_DSL/frescox_inputs/sfresco.in > /mnt/hgfs/Fresco_DSL/frescox_outputs/48Ca.out")

# Read outputs
files = ['/mnt/hgfs/Fresco_DSL/frescox_outputs/48Ca.out']
outs = []
for file in files:
    with open(file) as f:
        content = f.readlines()
